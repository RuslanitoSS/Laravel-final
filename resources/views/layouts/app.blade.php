...
<body>
    <header>
        <nav>
            <ul>
                ...
                <li><a href="{{ route('things.index') }}">Вещи</a></li>
                <li><a href="{{ route('places.index') }}">Места хранения</a></li>
                <li><a href="{{ route('uses.index') }}">Использования</a></li>
                @if (Auth::check())
                    <li><a href="{{ route('logout') }}">Выйти ({{ Auth::user()->name }})</a></li>
                @else
    ...
    <main>
        @if (session('status') === 'registered')
            <p class="success-message">Вы успешно зарегистрировались! Добро пожаловать!</p>
        @elseif (session('status') === 'logged-out')
            <p class="info-message">Вы успешно вышли из системы. До встречи!</p>
        @elseif (session('status') === 'logged-in')
            <p class="info-message">Вы успешно вошли в систему. Привет!</p>
        @endif
        @yield('content')
    </main>
